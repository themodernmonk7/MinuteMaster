...
const QuizResult = () => {
  const { closeResultScreen, correct, questions, timeTaken } =
    useGlobalContext()
      ...
      <div className="space-y-5">
        ...
        <div className=" flex justify-between font-rubik px-5 ">
          <div className=" ">
            ...
            <span className=" font-extrabold text-3xl text-primary-color-500 ">
              {" "}
          ...
          <div className="">
            ...
            <span className=" font-extrabold text-3xl text-primary-color-500 ">
              {" "}
              {timeFormat} <span className=" text-black text-sm ">sec</span>{" "}
            </span>
            <p className=" font-semibold text-sm mt-1">Avg: {timeFormat} sec</p>
          </div>
        </div>
      </div>
      <Button onClick={closeResultScreen} text="play again" />
    </section>
  )
}
